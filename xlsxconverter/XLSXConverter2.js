...
//                       typeEntry._type = parts[0];
    ...
    var getDataTableModelFromSpecification = function(specification) {
        ...
        if ( specification.settings.table_id.value !== "framework" ) {
            ...
            dataTableModel._filter_ext = { type: 'string', isNotNullable: false, elementKey: "_filter_ext", elementName: "_filter_ext", elementSet: 'instanceMetadata', elementPath: "_filter_ext" };
            ...
            dataTableModel._group_type = { type: 'string', isNotNullable: false, elementKey: "_group_type", elementName: "_group_type", elementSet: 'instanceMetadata', elementPath: "_group_type" };
            dataTableModel._groups_list = { type: 'string', isNotNullable: false, elementKey: "_groups_list", elementName: "_groups_list", elementSet: 'instanceMetadata', elementPath: "_groups_list" };
