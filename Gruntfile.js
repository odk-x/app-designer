...
var setHeaders = function (res, path) {
    ...
    res.setHeader(
        ...
        `frame-ancestors 'self' http://localhost:${SERVER_PORT} http://localhost:${LIVERELOAD_PORT}`
    );
                ...
                app: {
                    app: (function () {
                        ...
                        if (
                            ...
                            // Linux expects google-chrome.
                            grunt.log.writeln("detected Linux environment");
                            return "google-chrome";
                        } else {
                            // Default to any browser you prefer, or leave blank to open in the system's default browser.
                            grunt.log.writeln("detected unknown environment");
                            return null; // null or '' will use the system's default browser.
                        }
                    })(),
                },
            },
    ...
    grunt.registerTask(
        ...
        function (tableId) {
            if (arguments.length !== 1) {
                ...
                var detailHtml = {
                    srcPath:
                        tablesConfig.tableTemplateDir + "/html/detail.html",
