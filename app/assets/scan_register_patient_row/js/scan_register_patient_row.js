...
var tableId = 'scan_register_patient_row';
var resumeFn = function(idxStart) {

    var scan_out_dir_value = util.getQueryParameter(scan_out_dir);
    if (scan_out_dir_value === null || scan_out_dir_value === undefined) {
        data = control.query(tableId, null, null); 
    } else {
        //var decoded_scan_out_dir_value = decodeURI(scan_out_dir_value);
        ...
        data = control.query(tableId, whereClause, selectionArgs); 
    }
        ...
        $('#list').click(function(e) {
            ...
            if (rowId !== null && rowId !== undefined) {
                ...
                control.openDetailView(
                    tableId,
                    rowId,
                    'assets/scan_register_patient_row/html/scan_register_patient_row_detail.html');
            }
        });
    }
...
var displayGroup = function(idxStart) {
    ...
    for (var i = idxStart; i < idxStart + chunk; i++) {
        ...
        var addrUriRelative = data.getData(i, 'Name_image0.uriFragment');
        var addrSrc = '';
