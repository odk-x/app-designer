...
function cbFailure(error) {
    ...
    console.log('scan_example_list: cbFailure failed with error: ' + error);
}
        ...
        $('#list').click(function(e) {
            ...
            if (rowId !== null && rowId !== undefined) {
                ...
                odkTables.openDetailView(null,
                    tableId,
                    rowId,
                    'config/tables/scan_example/html/scan_example_detail.html');
            }
        });
...
var displayGroup = function(idxStart) {
    ...
    for (var i = idxStart; i < idxStart + chunk; i++) {
        ...
        item.text(resultSet.getData(i, 'name'));
        ...
        var addrUriRelative = resultSet.getData(i, 'address_image0.uriFragment');
        var addrSrc = '';
        if (addrUriRelative !== null && addrUriRelative !== "") {
            var addrUriAbsolute = odkCommon.getRowFileAsUrl(resultSet.getTableId(), resultSet.getRowId(i), addrUriRelative);
