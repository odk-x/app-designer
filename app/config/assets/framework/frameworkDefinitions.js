window.odkFrameworkDefinitions = {
  "_tokens": {
    ...
    "survey_form_identification": {
      ...
      "text": {
        "default": "<div><center><span style='color: #DF961F; font-weight:bold; margin-top:50%;'>SURVEY</span></center><hr></div><div><p>Form name: {{localizeText form_title}}</p>{{#if form_version}}<p>Form version: {{form_version}}</p>{{/if}}<hr></div>",
